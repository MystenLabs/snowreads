  ...
  return (
    <footer className="bg-secondary border-t border-gray-300 p-5 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 w-full">
      <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6 text-sm text-gray-600">
        <p className="text-center md:text-left">Copyright {new Date().getFullYear()} © Mysten Labs, Inc.</p>
      ...
      <div className="flex space-x-6 justify-center items-center">
        <a href="https://x.com/WalrusProtocol" aria-label="X" target="_blank" rel="noopener noreferrer">
          <img 
            src="/x_logo.png" 
            alt="X logo" 
        ...
        <a href="https://discord.com/invite/walrusprotocol" aria-label="Discord" target="_blank" rel="noopener noreferrer">
          <img 
