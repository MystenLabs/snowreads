      ...
      <section className="flex flex-col items-center justify-center flex-grow bg-primary px-8 sm:px-12 lg:px-16">
        <div className="lg:max-w-[1100px] w-full mx-auto py-8">
          ...
          <p className="text-gray-600 mb-6 text-left">
            ...
            purpose. (2) Mysten Labs does not guarantee that the Services will
            be free from errors, bugs, or interruptions in service, including
            failed transactions for which you have paid associated gas fees. Any
            use of the Services is at your own risk. (3) Mysten Labs shall not
            be liable for any direct, indirect, incidental, special, or
            consequential damages, whether arising from the use of the Services
            or any inability to use the Services, even if Mysten Labs has been
            advised of the possibility of such damages. (4) It is your
            responsibility to evaluate the accuracy, completeness, and
            usefulness of any information, content, or data provided by the
            Services. (5) Mysten Labs is under no obligation to provide support,
            maintenance, updates, or fixes for the Services. (6) Mysten Labs is
            not obligated to correct or address any errors, defects, or issues
            identified in the Services. (7) Mysten Labs may change, update, or
            discontinue the Services at any time without notice. (8) Your use of
            the Services indicates your acceptance of the risk associated with
            its use.
          </p>
          ...
          <p className="text-gray-600 mb-6 text-left">
            <strong>D. UserResponsibilities.</strong> You agree not to
            reproduce, distribute, publicly display, perform, or create
            derivative works from the Licensed Content without express
            permission from the rights holder, except as permitted under
            applicable copyright laws.
          </p>

          <p className="text-gray-600 mb-6 text-left">
            <strong>E. No Unauthorized Use:</strong> You are solely responsible
            for your use of the Services and any Licensed Content accessed
            through it. The content is provided solely for informational and
            personal use. You agree that your use of the Service, including
            accessing, downloading, or otherwise using Licensed Content, is at
            your own discretion and risk. When using the Service, you agree
            that:
          </p>
          {/* TODO */}
          <p>
            a. Compliance with Licenses: You are solely responsible for ensuring
            that your use of the Licensed Content complies with the applicable
            copyright license terms. Misuse of Licensed Content may result in
            suspension of your account or other legal consequences.
          </p>
          <p>
            b. Prohibited Uses: You may not use the Licensed Content for
            commercial purposes, redistribute it, or attempt to sublicense it
            unless specifically permitted by the applicable license or with
            explicit permission from the copyright owner.
          </p>
          <p>
            c. No Circumvention: You agree not to circumvent, disable, or
            otherwise interfere with any digital rights management (DRM)
            technologies or content protection mechanisms applied to the
            Licensed Content.
          </p>
          <p>
            d. Attribution. Certain Licensed Content may require you to provide
            appropriate attribution to the original author or copyright owner as
            specified in the applicable license (e.g., Creative Commons
            licenses). Failure to provide proper attribution may result in legal
            liability.
          </p>
          ...
          <p className="text-gray-600 mb-6 text-left">
            A.
            Use,display,mirrororframetheServicesoranyindividualelementwithinthe
            Services, Mysten Labs’s name, any Mysten Labs trademark, logo or
            other proprietary information, or the layout and design of any page
            or form contained on a page, without Mysten Labs’s express written
            consent; B.
            Access,tamperwith,orusenon-publicareasoftheServices,MystenLabs’s
            computer systems, or the technical delivery systems of Mysten Labs’s
            providers; C.
            Attempttoprobe,scanortestthevulnerabilityofanyMystenLabssystemor
            network or breach any security or authentication measures; D.
            ...
            user) to protect the Services; E.
            ...
            or other generally available third-party web browsers; F. Send any
            ...
            Labs’s express written consent; H.
            ...
            Terms; I. Forge any TCP/IP packet header or any part of the header
            ...
            information; J. Attempt to decipher, decompile, disassemble or
            ...
            Services; L. Collect or store any personally identifiable
            information from the Services from other users of the Services
            without their express permission; M. Impersonate or misrepresent
            your affiliation with any person or entity; N.
            Violateanyapplicablelaworregulation;or O. Encourage or enable any
            other individual to do any of the foregoing. Mysten Labs is not
            obligated to monitor access to or use of the Services or to review
            or edit any content. However, we have the right to do so for the
            ...
            access to any content, at any time and without notice, including,
            but not limited to, if we, at our sole discretion, consider it
          ...
          <p className="text-gray-600 mb-6 text-left">
            ...
            contact Mysten Labs at legal@mystenlabs.com.
          </p>
